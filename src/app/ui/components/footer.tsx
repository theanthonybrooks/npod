...
export const Footer = () => {
  return (
    <footer className="mx-auto flex w-full max-w-[85vw] flex-col items-center gap-4 py-4">
      <div className="text-foreground mx-auto flex w-full flex-col-reverse items-center justify-around gap-1 gap-x-8 rounded-full bg-white/90 p-4 text-sm sm:max-w-max sm:flex-row sm:px-8">
        <p>
          Made by{" "}
